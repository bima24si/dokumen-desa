            ...
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="row g-4">
                        ...
                        {{-- 2. Lampiran (Attachments) --}}
                        <div class="col-md-6">
                            <div class="card h-100 border">
                                <div class="card-header bg-white fw-bold">
                                    <i class="fas fa-paperclip me-2"></i>Lampiran / Attachment
                                </div>
                                <ul class="list-group list-group-flush">
                                    @forelse($dataDokumenHukum->attachments as $lampiran)
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            <div class="d-flex align-items-center overflow-hidden">
                                                <i class="far fa-file-alt me-3 text-secondary"></i>
                                                <span class="text-truncate" style="max-width: 200px;" title="{{ $lampiran->file_name }}">
                                                    {{ $lampiran->file_name }}
                                                </span>
                                            </div>
                                            <a href="{{ route('dokumen-hukum.download-attachment', $lampiran->id) }}" class="btn btn-sm btn-outline-primary">
