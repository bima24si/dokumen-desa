...
<head>
  ...
  <meta name="keywords" content="bootstrap, bootstrap4" />
        ...
        {{-- end css --}}
		<title>Edit Jenis Dokumen</title>
	</head>
				...
				<div class="col-lg-10">
					...
					<nav aria-label="breadcrumb" class="mb-4">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active">Edit Jenis Dokumen</li>
						</ol>
					</nav>
					...
					<div class="row mb-4">
						<div class="col-md-6">
							<h2 class="section-title">Edit Jenis Dokumen</h2>
							<p>Form untuk mengubah jenis dokumen</p>
						</div>
					...
					<div class="card border-0 shadow">
						<div class="card-body p-5">
							<form action="{{ route('jenis-dokumen.update', $dataJenisDokumen->id) }}" method="POST">
								@method('PUT')
								@csrf
								<div class="row">
									<div class="col-md-6">
										<div class="mb-4">
											...
											<input type="text" class="form-control @error('nama_jenis') is-invalid @enderror"
												   ...
												   value="{{ old('nama_jenis', $dataJenisDokumen->nama_jenis) }}"
									...
									<div class="col-md-6">
										<div class="mb-4">
											...
											<textarea class="form-control @error('deskripsi') is-invalid @enderror"
													  ...
													  placeholder="Masukkan deskripsi jenis dokumen">{{ old('deskripsi', $dataJenisDokumen ->deskripsi) }}</textarea>
											@error('deskripsi')
												<div class="invalid-feedback">{{ $message }}</div>
											@enderror
										</div>
